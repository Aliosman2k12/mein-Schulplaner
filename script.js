...
async function materialHinzufuegen() {
    ...
    // Eigener Ordner für jeden Benutzer
...
function materialAnzeigen() {
    ...
    if (gefilterteMaterialien.length === 0) {

        container.innerHTML =
            "<p>Kein Lernmaterial für dieses Fach vorhanden.</p>";
